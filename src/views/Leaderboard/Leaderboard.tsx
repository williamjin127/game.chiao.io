...
export default function Leaderboard() {
    ...
    const fetchCompetitionResults = async (page = 1, refresh = true) => {
        ...
        try {
            const { results: newResults, next } = await ApiService.getCompetitionResults(
                page,
                {
                    sort: sortBy,
                    sortdirection: sortDirection
                    ...
                    <Grid item sx={{ width: "100%" }}>
                        <Grid container direction="column">
                            ...
                            {tabLoading ? (
                                ...
                                <Grid item sx={{width: "100%"}}>
                                    <TableContainer sx={{borderRadius: "5px", position: "relative"}}>
                                        {sortLoading && (
                                            <Box
                                                sx={{
                                                    position: "absolute",
                                    ...
                                    {hasNextPage && (
                                        <Grid item mt={2} sx={{textAlign: "center"}}>
                                            <Button
                                                ...
                                                variant="contained"
                                                color="warning"
                                                endIcon={loadMoreLoading ? <CircularProgress size={18} /> : null}
                                            >
                                                Load more
                                            </Button>
                                        </Grid>
